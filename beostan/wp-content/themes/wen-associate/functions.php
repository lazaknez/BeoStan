 ...
 */
function wen_associate_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'wen_associate_content_width', 738 );
}
add_action( 'after_setup_theme', 'wen_associate_content_width', 0 );

if ( ! function_exists( 'wen_associate_template_redirect' ) ) :
	/**
	 * Set the content width in pixels, based on the theme's design and stylesheet for different value other than the default one
	 *
	 * @global int $content_width
	 */
	function wen_associate_template_redirect() {
		$global_layout = wen_associate_get_option( 'global_layout' );

		// No Sidebar (Full Width)
		if ( 'no-sidebar' === $global_layout ) {
			$GLOBALS['content_width'] = 1138;
		}
		// Three Columns
...
add_action( 'template_redirect', 'wen_associate_template_redirect' );
...
function wen_associate_scripts() {
	...
	wp_enqueue_style( 'wen-associate-style', get_stylesheet_uri(), array(), $theme_version );
